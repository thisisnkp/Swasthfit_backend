  ...
  try {
    ...
    if (
      ...
      return res.status(400).json({
        success: false,
        message:
          "All required fields (first_name, last_name, mobile, date_of_birth, home_location_name, home_latitude, home_longitude, aadhar_number, type_of_rider, owner_id) must be provided.",
      });
    }
