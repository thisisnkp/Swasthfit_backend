...
// Commission
router.post("/comission", verifyToken, commissionController.createCommission);
router.get("/comission", verifyToken, commissionController.getCommissions);
...
router.get("/diets-by-restaurant/:restaurantId", verifyToken, restaurantController.getAllDietsByRestaurant);
router.post("/rest/market", restaurantController.generateToken);
router.post("/rest/:restaurantId/users/import", verifyToken, restaurantController.importCustomers);
router.post("/addToCart", verifyToken, restaurantController.addToCart);
router.get("/restaurant/:id/users", restaurantController.getUsersByRestaurantId);

// Store Settings
router.post("/store-setting-create", verifyToken, storeSettingController.createSettings);
router.get("/store-setting/:restaurantId", verifyToken, storeSettingController.getSettingsByRestaurantId);
router.put("/store-setting/update/:restaurantId", verifyToken, storeSettingController.updateSettingsByRestaurantId);
...
router.get("/food/item/:id", verifyToken, foodItemController.getFoodItemById);
...
router.get("/order-details/:orderId", verifyToken, orderController.getOrderDetails);
...
router.post("/add-address", verifyToken, orderController.addAddress);
router.post("/add-to-fav", verifyToken, orderController.addFavoriteItem);

// Invoices
router.post("/invoices/create", verifyToken, invoiceController.createInvoice);
router.get("/invoice/:invoice_id", verifyToken, invoiceController.getInvoiceWithItems);
router.get("/invoices/get/:invoiceId", verifyToken, invoiceController.getInvoiceByInvoiceId);
router.get("/invoices-all", verifyToken, invoiceController.getAllInvoices);
