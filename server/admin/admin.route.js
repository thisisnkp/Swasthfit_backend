...
const { createAdminKYC, getAdminKYC, updateAdminKYC, deleteAdminKYC } = require("./admin_kyc_details/admin.kyc.controller");
const {
    addingQNAData,
    updateAnswer,
...
router.post("/createAdminDetails",verifyJWT, AdminDetailsController.createAdmin);

// Get all admin details
router.get("/getAdminDetails", AdminDetailsController.getAllAdmins);

// Get admin details by ID
router.get("/getAdminDetailsById",verifyJWT, AdminDetailsController.getAdminById);

// Update admin details by ID
router.put("/updateAdminDetails",verifyJWT, AdminDetailsController.updateAdmin);
...
// Get amenities by ID
router.get("/getAmenitiesById/:id", AmenitiesController.getAmenitiesById);
