...
const trainerModel = require("../../../user/models/trainer.model");
          ...
          errors: [
            {
              ...
              displayMessage: `Invalid schedule format for day: ${JSON.stringify(
                dayObj
              )}`,
            },
          ],
    ...
    await WorkoutModel.update(
      {
        ...
        sub_exercise_name:
          workoutData.sub_exercise_name || existingWorkout.sub_exercise_name,
        sets:
          workoutData.sets !== undefined
            ? workoutData.sets
            : existingWorkout.sets,
        reps:
          workoutData.reps !== undefined
            ? workoutData.reps
            : existingWorkout.reps,
        duration:
