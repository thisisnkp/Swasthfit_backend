...
const config = {
  ...
  enable_iframe: parseInt(process.env.EASEBUZZ_IFRAME),
};
...
// Generate UPI Payment Link API
app.post("/generate-upi-link", function (req, res) {
